...
namespace MyLINQSQL
{
    ...
    partial void InsertEproduct(Eproduct instance);
    partial void UpdateEproduct(Eproduct instance);
    partial void DeleteEproduct(Eproduct instance);
    #endregion
		...
		public System.Data.Linq.Table<Eproduct> Eproducts
		{
			get
			{
				return this.GetTable<Eproduct>();
			}
		}
	}
	
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.Eproduct")]
	public partial class Eproduct : INotifyPropertyChanging, INotifyPropertyChanged
	{
